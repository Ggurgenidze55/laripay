  ...
  return (
    <>
      ...
      <section className="relative overflow-hidden border-t border-border py-40 md:py-48">
        ...
        {lite ? (
          <div className="pointer-events-none absolute left-1/2 top-1/2 h-[min(400px,70vw)] w-[min(400px,70vw)] -translate-x-1/2 -translate-y-1/2 rounded-full bg-accent-violet/15 blur-3xl" />
        ) : (
          <>
            <motion.div
